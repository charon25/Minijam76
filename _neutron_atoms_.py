...
class U235(atoms.NeutronAtom):
    ...
    def is_hit_by_neutron(self, neutron):
        ...
        if self.type == co.U235_NEUTRON:
            self.created_atoms.append(decaying_atoms.U236(self.x, self.y))
...
class Pu239(atoms.NeutronAtom):
    ...
    def is_hit_by_neutron(self, neutron):
        ...
        self.created_neutrons += [neut1, neut2, neut3]
        #Atomes
        zr = stable_atoms.Zr103(cx - co.ZR103_SIZE / 2, cy - co.ZR103_SIZE / 2)
        xe = stable_atoms.Xe134(cx - co.XE134_SIZE / 2, cy - co.XE134_SIZE / 2)
